...
export default function HealthFormPage() {
  ...
  function onSubmit(values: z.infer<typeof healthFormSchema>) {
    ...
    // After successful submission, navigate back to the dashboard
  ...
  return (
    <div className="w-full container mx-auto py-10">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Comprehensive Health Assessment</h1>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="List any recent travel..."
                        className="resize-none"
                        {...field}
                      />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="List any recent screening tests..."
                        className="resize-none"
                        {...field}
                      />
                    </FormControl>
