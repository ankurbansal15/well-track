...
import { BoltIcon, ChartBarSquareIcon, ArrowDownTrayIcon, HeartIcon, ChartBarIcon, ShareIcon, FireIcon, BeakerIcon, CalendarDaysIcon } from '@heroicons/react/24/solid'
                    ...
                    <div key={macro.name} className="space-y-2">
                      ...
                      <div className="h-2 bg-red-200 rounded-full overflow-hidden">
                        <div 
                          className="h-full bg-white" 
                          style={{ 
                            width: `${(parseInt(macro.amount) / parseInt(macro.target)) * 100}%` 
                          }} 
                        />
                      </div>
                    </div>
